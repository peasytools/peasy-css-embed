...
[![npm](https://img.shields.io/npm/v/peasy-css-embed)](https://www.npmjs.com/package/peasy-css-embed)
[![License: MIT](https://img.shields.io/badge/License-MIT-blue.svg)](https://opensource.org/licenses/MIT)
[![Zero Dependencies](https://img.shields.io/badge/dependencies-0-brightgreen)](https://www.npmjs.com/package/peasy-css-embed)
[![Size](https://img.shields.io/badge/gzipped-<8KB-green)](https://bundlephobia.com/package/peasy-css-embed)

Embed **PeasyCSS** widgets on any website or blog. CSS tools, minification, formatting, color conversion, and previews. Each widget is completely isolated via **Shadow DOM**, requires **zero dependencies**, and supports **3 built-in themes** (light, dark, sepia). The self-executing script finds all `data-peasy-css` elements on the page and renders interactive widgets automatically, including support for dynamically added elements in single-page applications via MutationObserver.

PeasyCSS is part of the [Peasy Tools](https://peasytools.com) ecosystem, providing 14 widget types for embedding file format information, tool cards, conversion guides, glossary terms, search boxes, and interactive tools directly into your pages.

> **Try the interactive widget builder at [widget.peasycss.com](https://widget.peasycss.com)** -- build, preview, and copy embed code for any widget type.

<p align="center">
  <img src="demo.gif" alt="peasy-css-embed demo -- embed peasycss widgets with Shadow DOM isolation and theme support" width="800">
</p>
...
<div data-peasy-css="tool"
  data-slug="minify-css"
  data-theme="light">
</div>
...
That's it. The script will find all `data-peasy-css` elements, fetch data from the PeasyCSS API, and render each widget with full Shadow DOM style isolation.

## Widget Types

PeasyCSS supports 14 widget types -- 11 common types available on all Peasy sites plus 3 site-specific tools.

| Type | Description | Usage |
|------|-------------|-------|
| `format` | File format info card with specs, MIME type, and use cases | `<div data-peasy-css="format" data-slug="..."></div>` |
| `tool` | Tool card with description and direct launch link | `<div data-peasy-css="tool" data-slug="..."></div>` |
| `convert` | Conversion card showing input/output format pair | `<div data-peasy-css="convert" data-slug="..."></div>` |
| `compare` | Side-by-side comparison of two formats or tools | `<div data-peasy-css="compare" data-slug="..."></div>` |
| `glossary` | Glossary term tooltip with definition on hover | `<div data-peasy-css="glossary" data-slug="..."></div>` |
| `gallery` | Grid gallery of available tools for a category | `<div data-peasy-css="gallery" data-slug="..."></div>` |
| `guide` | Guide/tutorial card with summary and read-more link | `<div data-peasy-css="guide" data-slug="..."></div>` |
| `usecase` | Use-case card showing when and why to use a tool | `<div data-peasy-css="usecase" data-slug="..."></div>` |
| `badge` | Inline badge showing format type or tool category | `<div data-peasy-css="badge" data-slug="..."></div>` |
| `search` | Search box with autocomplete for tools and formats | `<div data-peasy-css="search" data-slug="..."></div>` |
| `interactive` | Embedded interactive tool via iframe | `<div data-peasy-css="interactive" data-slug="..."></div>` |
| `preview` | Live CSS preview pane | `<div data-peasy-css="preview"></div>` |
| `minify` | Client-side CSS minification tool | `<div data-peasy-css="minify"></div>` |
| `color` | CSS color converter (hex/rgb/hsl) | `<div data-peasy-css="color"></div>` |
...
|-----------|--------|---------|-------------|
| `data-peasy-css` | format, tool, convert, compare, glossary, gallery, guide, usecase, badge, search, interactive, preview, minify, color | *required* | Widget type to render |
...
<div data-peasy-css="tool" data-slug="minify-css" data-theme="light"></div>

<!-- Dark theme -- dark background, light text -->
<div data-peasy-css="tool" data-slug="minify-css" data-theme="dark"></div>

<!-- Sepia theme -- warm, paper-like appearance -->
<div data-peasy-css="tool" data-slug="minify-css" data-theme="sepia"></div>

<!-- Auto theme -- follows prefers-color-scheme -->
<div data-peasy-css="tool" data-slug="minify-css" data-theme="auto"></div>
```

Each theme sets CSS custom properties inside the Shadow DOM. The accent color (`#06B6D4`) is consistent across all themes, providing brand recognition for PeasyCSS.
...
```html
<script type="module">
  import 'https://cdn.jsdelivr.net/npm/peasy-css-embed@1/dist/embed.esm.js';
</script>
```
...
```html
<!-- PeasyCSS format info card with light theme -->
<div data-peasy-css="format" data-slug="minify-css" data-theme="light"></div>
<script src="https://cdn.jsdelivr.net/npm/peasy-css-embed@1/dist/embed.min.js"></script>
```
...
```html
<!-- Search across PeasyCSS tools and formats -->
<div data-peasy-css="search"
  data-placeholder="Search PeasyCSS tools..."
  data-theme="light">
</div>
<script src="https://cdn.jsdelivr.net/npm/peasy-css-embed@1/dist/embed.min.js"></script>
```
...
```html
<p>This file is in <div data-peasy-css="badge" data-slug="minify-css"></div> format.</p>
<script src="https://cdn.jsdelivr.net/npm/peasy-css-embed@1/dist/embed.min.js"></script>
```
...
```html
<div data-peasy-css="glossary" data-slug="lossless" data-theme="light"></div>
<script src="https://cdn.jsdelivr.net/npm/peasy-css-embed@1/dist/embed.min.js"></script>
```
...
- **CORS**: PeasyCSS API has CORS enabled for all origins
...
- **Powered by**: Each widget includes a subtle "PeasyCSS" backlink in the footer

## Learn More

Visit [peasycss.com](https://peasycss.com) for the full PeasyCSS experience.

- **All Tools**: [peasycss.com](https://peasycss.com)
- **Formats**: [peasycss.com/formats/](https://peasycss.com/formats/)
- **Glossary**: [peasycss.com/glossary/](https://peasycss.com/glossary/)
- **Guides**: [peasycss.com/guides/](https://peasycss.com/guides/)
- **API Documentation**: [peasycss.com/developers/](https://peasycss.com/developers/)
- **OpenAPI Spec**: [peasycss.com/api/openapi.json](https://peasycss.com/api/openapi.json)
- **Widget Builder**: [widget.peasycss.com](https://widget.peasycss.com)
- **npm Package**: [npmjs.com/package/peasy-css-embed](https://www.npmjs.com/package/peasy-css-embed)
